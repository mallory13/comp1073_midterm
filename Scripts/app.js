...
var travelReport = (function () {
    ...
    IntroParagraph = document.getElementById("IntroParagraph").innerHTML = "<p>Now is the time to travel to Greece. The country may be going through an economic crisis, but many travellers say that it hasn't impacted the experience of visiting. Plus, there may be some great deals.</p> <p>Greece has 1,400 islands, though only 230 of them are inhabited. </p><p>And while everyone knows about Santorini and Mykonos, there are gorgeous lesser-known islands in Greece, too.</p> ";
